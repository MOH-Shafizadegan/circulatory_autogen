...
root_dir = r"C:\Users\jebollen\OneDrive - UGent\Documents\Research\1-WP\CellModels\0_ABI_SMC\CircAutogen\FirstTry\circulatory_autogen"
...
units_cellml = os.path.join(root_dir, 'src/generators/resources/units.cellml')
...
time_variable = "t"
component_name = "all"
input_model = r"C:\Users\jebollen\OneDrive - UGent\Documents\Research\1-WP\CellModels\0_ABI_SMC\CircAutogen\FirstTry\circulatory_autogen\CA_user\smc_kapela\smc_kapela.cellml"
output_dir = r"C:\Users\jebollen\OneDrive - UGent\Documents\Research\1-WP\CellModels\0_ABI_SMC\CircAutogen\FirstTry\circulatory_autogen\CA_user\smc_kapela\output"

def create_modules_files(dir_model, dir_output, name_prefix, data_ref,comp_name):
    global file_prefix, vessel_name, data_reference, time_variable, component_name, input_model, output_dir

    # Define file_prefix, vessel_name and data_reference for the model
    # Specify the time variable and component for which you want to generate files
    file_prefix = name_prefix
    vessel_name = name_prefix
    data_reference = data_ref
    time_variable = "t"
    component_name = comp_name
    input_model = os.path.join(dir_model, f"{name_prefix}.cellml")
